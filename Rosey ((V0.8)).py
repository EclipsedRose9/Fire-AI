...
def TestBTN():
    ...
    image_path = r"D:\Python Codes\Fire\test2.png" ###############################################################################
...
def GetPDA(x):
    if str(x) == "House Fire" and str(LiveAtRisk) == "No":
        ...
        PDA = "4 fire engines, 1 ladder and 1 officer in charge"
    elif str(x) == "High-Rise Fire":
        PDA = "5 fire engines, 1 aerial appliance, 1 command unit and multiple officers"
    elif str(x) == "Large Vehicle Fire":
        PDA = "2 fire engines, 1 ladder and 1 officer in charge"
    elif str(x) == "Bin/Small Rubbish Fire":
        PDA = "1 fire engine"
    elif str(x) == "Cladding Fire (High-Rise)":
        PDA = "8 fire engines, 3 ladders, multiple officers and command units."
    elif str(x) == "Fire with Fatality":
        PDA = "2 fire engines, 1 fire investigation unit and press officer notified"
...
def GetAIA(x): #if fire type needs areal and ladders add it, remove ai for non fire incietns
    if str(x) == "1":
        AIA = "1 fire engine and 1 officer in charge"
    elif str(x) == "2":
        AIA = "2 fire engines and 1 officer in charge"
    elif str(x) == "4":
        AIA = "4 fire engines, 1 officer in charge and 1 command unit"
    elif str(x) == "5":
        AIA = "5 fire engines, 1 officer in charge and 1 command unit"
    elif str(x) == "6":
        AIA = "6 fire engines, 1 officer in charge and 1 command unit"
    elif str(x) == "8":
        AIA = "8 fire engines, multiple officer in charge and command unit"
    elif str(x) == "10":
        AIA = "10 fire engines, multiple officer in charge and command unit"
    elif str(x) == "12":
        AIA = "12 fire engines, multiple officer in charge and command unit" 
    elif str(x) == "15":
        AIA = "15 fire engines, multiple officer in charge and command unit"
    elif str(x) == "20":
        AIA = "20 fire engines, multiple officer in charge and command unit"
    elif str(x) == "25":
        AIA = "25 fire engines, multiple officer in charge and command unit"
    elif str(x) == "30":
        AIA = "30 fire engines, multiple officer in charge and command unit"  
    elif str(x) == "40":
        AIA = "40 fire engines, multiple officer in charge and command unit" 
    else:
        pass
    return AIA
...
def Logic():
    PDA = GetPDA(IncidentType)
    AIA = GetAIA(predicted_class)
    RosyText.config(text="Rosy says: 'There is a "+str(IncidentType)+" at "+str(Adress)+". There is a predetermined attendance of "+PDA+"\nFrom my experince I believe that this fire should have "+AIA+".")
