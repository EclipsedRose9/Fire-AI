...
def Logic():
    ...
    RoseyText.config(text="Rosey says: 'There is a "+str(IncidentType)+" at "+str(Adress)+" "+str(Borough)+" "+str(Postcode)+". I recommend the attendance of "+PDA+".")
...
#Lists
ALL
F1 = open("CallTranscript"+str(NB)+".txt", "r")
D1 = F1.readlines()
L1 = [D1] #Barking and\nDagenham

F2 = open("CallTranscript"+str(NB)+".txt", "r")
L2 = [F2] #Barnet

F3 = open("CallTranscript"+str(NB)+".txt", "r")
L3 = [F3] #Bexley

F4 = open("CallTranscript"+str(NB)+".txt", "r")
L4 = [F4] #Brent

F5 = open("CallTranscript"+str(NB)+".txt", "r")
L5 = [F5] #Bromley

F6 = open("CallTranscript"+str(NB)+".txt", "r")
L6 = [F6] #Camden

F7 = open("CallTranscript"+str(NB)+".txt", "r")
L7 = [F7] #City

F8 = open("CallTranscript"+str(NB)+".txt", "r")
L8 = [F8] #Croydon

F9 = open("CallTranscript"+str(NB)+".txt", "r")
L9 = [F9] #Ealing

F10 = open("CallTranscript"+str(NB)+".txt", "r")
L10 = [F10] #Enfield

F11 = open("CallTranscript"+str(NB)+".txt", "r")
L11 = [F11] #Greenwich

F12 = open("CallTranscript"+str(NB)+".txt", "r")
L12 = [F12] #Hackney

F13 = open("CallTranscript"+str(NB)+".txt", "r")
L13 = [F13] #Hammersmith\nand Fulham

F14 = open("CallTranscript"+str(NB)+".txt", "r")
L14 = [F14] #Haringey

F15 = open("CallTranscript"+str(NB)+".txt", "r")
L15 = [F15] #Harrow

F16 = open("CallTranscript"+str(NB)+".txt", "r")
L16 = [F16] #Havering

F17 = open("CallTranscript"+str(NB)+".txt", "r")
L17 = [F17] #Hillingdon

F18 = open("CallTranscript"+str(NB)+".txt", "r")
L18 = [F18] #Hounslow

F19 = open("CallTranscript"+str(NB)+".txt", "r")
L19 = [F19] #Islington

F20 = open("CallTranscript"+str(NB)+".txt", "r")
L20 = [F20] #Kensington\nand Chelsea

F21 = open("CallTranscript"+str(NB)+".txt", "r")
L21 = [F21] #Kingston\nupon\nThames

F22 = open("CallTranscript"+str(NB)+".txt", "r")
L22 = [F22] #Lambeth

F23 = open("CallTranscript"+str(NB)+".txt", "r")
L23 = [F23] #Lewisham

F24 = open("CallTranscript"+str(NB)+".txt", "r")
L24 = [F24] #Merton

F25 = open("CallTranscript"+str(NB)+".txt", "r")
L25 = [F25] #Newham

F26 = open("CallTranscript"+str(NB)+".txt", "r")
L26 = [F26] #Redbridge

F27 = open("CallTranscript"+str(NB)+".txt", "r")
L27 = [F27] #Richmond\nupon Thames

F28 = open("CallTranscript"+str(NB)+".txt", "r")
L28 = [F28] #Southwark

F29 = open("CallTranscript"+str(NB)+".txt", "r")
L29 = [F29] #Sutton

F30 = open("CallTranscript"+str(NB)+".txt", "r")
L30 = [F30] #Tower\nHamlets

F31 = open("CallTranscript"+str(NB)+".txt", "r")
L31 = [F31] #Waltham\nForest

F32 = open("CallTranscript"+str(NB)+".txt", "r")
L32 = [F32] #Wandsworth

F33 = open("CallTranscript"+str(NB)+".txt", "r")
L33 = [F33] #Westminster
