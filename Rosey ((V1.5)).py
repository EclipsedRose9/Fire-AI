...
def Logic():  # Function to determine fire dispatch units and estimated response times
    ...
    if CSU > 0:
        UnitsNeeded.append(("CSU", CSU))  # Command Unit
    if ALP > 0:
    ...
    CurrentDataString = (f"\n...\nRosey says: There's a {IncidentType} at {Adress} {Borough} {Postcode} I recommend:\n{CurrentDataString} {PDA}").strip()
...
def Update():  # Function to process and update fire dispatch information
    ...
    global P, PL, FRU, Fireboat, CSU, ALP
...
def GetPDA(x, y):
    # Fire Incidents
    global P, PL, FRU, Fireboat, CSU, ALP, PDA
